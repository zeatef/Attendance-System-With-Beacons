...
namespace GUC_Attendance
{
	public class GUC_Attendance_Manager
	{
		...
		public IMobileServiceTable<BeaconMap> beaconmapAPITable;
		...
		public GUC_Attendance_Manager ()
		{
			...
			beaconmapAPITable = client.GetTable<BeaconMap>();
		...
		//insertion for beacon map

		public async Task AddBeacon()
		{
			var a = new BeaconMap
			{
				mac_address = "20:91:48:42:82:CA",
				beacon_room = "C3.331",
			...
			var b = new BeaconMap 
				{
				mac_address = "20:91:48:42:02:E3",
				beacon_room ="C3.331-Out",
			
				};

			var c = new BeaconMap
			{
				mac_address = "20:91:48:42:84:2F",
				beacon_room = "C3.328",
			...
			var d = new BeaconMap
			{
				mac_address = "20:91:48:42:86:91",
				beacon_room = "C3.328-Out",

			};

			var e = new BeaconMap
			{
				mac_address = "20:91:48:42:03:03:24",
				beacon_room = "C3.332",

			};
			var f = new BeaconMap
			{
				mac_address = "20:91:48:41:FB:A6",
				beacon_room = "C3.331-Out",
			
			};

			await beaconmapAPITable.InsertAsync(a);
			await beaconmapAPITable.InsertAsync(b);
			await beaconmapAPITable.InsertAsync(c);
			await beaconmapAPITable.InsertAsync(d);
			await beaconmapAPITable.InsertAsync(e);
			await beaconmapAPITable.InsertAsync(f);
